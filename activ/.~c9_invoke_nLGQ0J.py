...
class Rating_c(models.Model):
    #class Meta():
        #db_table =  'rating_c'
        #app_label = 'activ'
    rating = models.CharField(max_length=50, verbose_name ='Оценка конфиденциальности')
...
class Rating_i(models.Model):
    #class Meta():
       # db_table =  'rating_i'
       # app_label = 'activ'
    rating = models.CharField(max_length=50, verbose_name ='Оценка целостности')
    value = models.IntegerField(default=0, verbose_name ='Значение')
    def __str__(self):
        return '%s' % self.rating
    class Meta:
...
class Rating_a(models.Model):
    #class Meta():
        #db_table =  'rating_a'
        #app_label = 'activ'
    rating = models.CharField(max_length=50, verbose_name ='Оценка доступности')
    value = models.IntegerField(default=0, verbose_name ='Значение')
    def __str__(self):
        return '%s' % self.rating
...
class Activ (models.Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse('activ_details', args=[str(self.id)])
        return reverse('Templates/activ_id.html', kwargs={'pk': self.pk})
